...
$(function(){
	...
	setDropDownList(gender,genderObj);
	setDropDownList(userType,userTypeObj);
	setDropDownList(status,statusObj);
	
	var id = "${user.id}";
	$(".submit").on("click",function(){
		if(validateForm()){
			$.post("${pageContext.request.contextPath}/admin/user/update/"+id,$("#updateCustomer").serializeArray(),function(flag){
				console.log(flag);
				if(flag){
	...
	function validateForm(){
		return $("#updateCustomer").validate({
			rules:{
				username:"required",
				//password:"required",
				gender:"required",
						...
						<form id="updateCustomer" action="" method="post">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-4">
									  <input class="form-control company" name=username value='${user.username }'>
									</div>
									<div class="col-md-2">
								...
								<div class="row">
									...
									<div class="col-md-4">
									  <input class="form-control" type="text" name=wechat value='${user.wechat }'>
									</div>
									<div class="col-md-6">
									 <!--  <div class="radio">
									    <label>
