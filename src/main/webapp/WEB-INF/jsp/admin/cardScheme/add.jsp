...
$(function(){
	...
	$(".submit").on("click",function(){
		if(validateForm()){
			$.post("${pageContext.request.contextPath}/admin/cardScheme/add",$("#addCardScheme").serializeArray(),function(flag){
				console.log(flag);
				if(flag){
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">Add Card Scheme</h1>
				<div class="table-responsive">
					<div class="addCardScheme">
						<form id="addCardScheme" action="" method="post">
							<div class="container-fluid">
								<div class="row">
									<div class="col-md-2">
										<label>Name</label>
								...
								<div class="row">
									...
									<div class="col-md-4">
									  <input class="form-control calculate" type="text" name=amount>
									</div>
									<div class="col-md-2">
										<label>Plus</label>
									</div>
									<div class="col-md-4">
										<input class="form-control calculate" type="text" name=plus>
									</div>
								</div>
								<br/>
								<div class="row">
