...
<script type="text/javascript">
	...
	$(function() {
		...
		var table = $("#myTable").DataTable(
			{
				...
				"ajaxSource" : "${pageContext.request.contextPath}/admin/cardScheme/listByPage",//这个是请求的地址
				...
				"columns" : [
						...
						},
						{
							...
							"render" : function(data, type, row) {
								var button;
								button = '<a href="${pageContext.request.contextPath}/admin/cardScheme/update/'+row.id+'" class="update btn btn-xs btn-warning glyphicon glyphicon-edit" data-trigger="hover" data-toggle="tooltip" data-placement="top" title="Edit"></a>&nbsp'
									+ '<button schemeId="'+row.id+'" class="remove btn btn-xs btn-danger glyphicon glyphicon-trash" data-trigger="hover" data-toggle="tooltip" data-placement="top" title="Delete"></button>'
								return button;
							}
						}
				],
			...
			type:'red',
			 buttons: {
				 Delete:{
					 ...
					 btnClass:'btn',
					 action:function(){
						 $.get("${pageContext.request.contextPath}/admin/cardScheme/delete/"+id,function(flag){
								if(flag){
	  ...
	  /*  table.columns().eq( 0 ).each( function ( colIdx ) {
		...
		$("div.new").html('<a href="${pageContext.request.contextPath}/admin/cardScheme/add" id="new" class="dt-button" style="float:left">New</a>');
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">Card Scheme List</h1>
