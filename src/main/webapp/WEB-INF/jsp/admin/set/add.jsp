...
$(function(){
	...
	$(".submit").on("click",function(){
		if(validateForm()){
			$.post("${pageContext.request.contextPath}/admin/set/add",$("#addSet").serializeArray(),function(flag){
				console.log(flag);
				if(flag){
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">Add Set</h1>
				<div class="table-responsive">
					<div class="addSet">
						<form id="addSet" action="" method="post">
							<div class="container-fluid">
								<div class="row">
									<div class="col-md-2">
										<label>Name</label>
								...
								<div class="row">
									...
									<div class="col-md-4">
									  <input class="form-control calculate" type="text" name=price>
									</div>
									<div class="col-md-2">
										<label>Coupon</label>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
									 <input class="form_datetime form-control" type="text" name=startFrom>
									</div>
									<div class="col-md-2">
										<label>Expire</label>
									</div>
									<div class="col-md-4">
										<input class="form_datetime form-control" type="text" name=expireTo>
									</div>
								</div>
								<br/>
								<div class="row">
