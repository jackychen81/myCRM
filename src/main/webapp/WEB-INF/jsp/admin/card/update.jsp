...
$(function(){
	...
	$(".submit").on("click",function(){
		//alert("a");
		if(validateForm()){
			$.post("${pageContext.request.contextPath}/admin/card/update/"+'${card.cid}',$("#updateCard").serializeArray(),function(flag){
				console.log(flag);
				if(flag){
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">Update Card</h1>
						...
						<form id="updateCard" action="" method="post">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-4">
									  <select id="username" class="form-control user" name="uid">
									  	<option></option>
									  </select>
									</div>
									<div class="col-md-2">
									...
									<div class="col-md-4">
										<select id="cardCategory" class="form-control cardCategory" name="cardCategory.cardCategoryId">
										  <option></option>
										</select>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
									  <input class="form-control" type="text" name=amount value='${card.amount }'>
									</div>
									<div class="col-md-2">
										<label>Plus Amount</label>
									</div>
									<div class="col-md-4">
									  <input class="form-control" type="text" name=plusAmount value='${card.plusAmount }'>
									</div>
								</div>
								<br/>
								<div class="row">
									...
									<div class="col-md-4">
									  <input class="form-control company" name=description value="${card.description }">
									</div>
								</div>
								<br/>
								<div class="row">
