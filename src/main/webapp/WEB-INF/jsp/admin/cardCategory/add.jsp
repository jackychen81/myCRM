...
$(function(){
	...
	$(".submit").on("click",function(){
		//alert("a");
		if(validateForm()){
			$.post("${pageContext.request.contextPath}/admin/cardCategory/add",$("#addCardCategory").serializeArray(),function(flag){
				console.log(flag);
				if(flag){
	...
	function validateForm(){
		return $("#addCardCategory").validate({
			rules:{
				name:"required",
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">Add Card Category</h1>
				<div class="table-responsive">
					<div class="addCardCategory">
						<form id="addCardCategory" action="" method="post">
							<div class="container-fluid">
								<div class="row">
									<div class="col-md-2">
										<label>Name</label>
									...
									<div class="col-md-4">
										<select class="form-control" name="cardCategoryStatus">
											<option></option>
