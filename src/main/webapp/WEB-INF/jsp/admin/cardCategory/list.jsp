...
<title>Card Category List</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		var table = $("#myTable").DataTable(
			{
				...
				"ajax" : "${pageContext.request.contextPath}/admin/cardCategory/listCardCategory",//这个是请求的地址
				...
				"columns" : [
				        {
				        	"data":"cardCategoryId","visible" : false,
				        },
						{
							"data" : "name"
						},
						...
						{
							"data" : "cardCategoryStatus","render":function(data, type, row){
								var status;
						...
						},
						{
							...
							"render" : function(data, type, row) {
								var button;
								button = '<a href="${pageContext.request.contextPath}/admin/cardCategory/update/'+row.cardCategoryId+'" class="update btn btn-xs btn-warning glyphicon glyphicon-edit" data-trigger="hover" data-toggle="tooltip" data-placement="top" title="Edit"></a>&nbsp'
									+'<button class="setRole btn btn-xs btn-default glyphicon glyphicon-edit" data-trigger="hover" data-toggle="tooltip" data-placement="top" title="Set Role"></button>&nbsp'
									+ '<button categoryId="'+row.cardCategoryId+'" class="remove btn btn-xs btn-danger glyphicon glyphicon-trash" data-trigger="hover" data-toggle="tooltip" data-placement="top" title="Delete"></button>'
								return button;
							}
						}
				],
			...
			type:'red',
			 buttons: {
				 Delete:{
					 ...
					 btnClass:'btn',
					 action:function(){
						 $.get("${pageContext.request.contextPath}/admin/cardCategory/delete/"+id,function(flag){
								if(flag){
	   ...
	   table.columns().eq( 0 ).each( function ( colIdx ) {
		...
		$("div.new").html('<a href="${pageContext.request.contextPath}/admin/cardCategory/add" id="new" class="dt-button" style="float:left">New</a>');
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">Card Category List</h1>
